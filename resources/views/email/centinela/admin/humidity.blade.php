...
El equipo del sr {{ $user->name }} con ID {{ $device->id }} se encuentra fuera de los limites establecidos de humedad por un tiempo mayor al que se ha determinado en el retardo al aviso.
