...
El equipo del sr {{ $user->name }} {{ $user->surname }} con ID {{ $device->id }} se encuentra fuera de set poin al no alcanzar el valor de humedad deseado en el tiempo previsto en el retardo para el aviso, en la configuracion del dispositivo.
