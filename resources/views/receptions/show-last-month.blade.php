        ...
        <div class="col-md-10 mb-3">
            <div class="card">
                <div class="card-header">
                    Datos del ultimo mes de {{ $device->name }} ({{ $device->description }})
                </div>
                <div class="card-body">
                    @if(isset($datas))
                ...
                <div class="card-footer">
                    ...
                    @can('receptions.show-month')
                        <a href="{{ route('receptions.show-month', $device->id) }}" class="btn btn-sm btn-primary m-1 active">Ver ultimo mes</a>
                    @endcan
